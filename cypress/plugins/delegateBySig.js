        ...
        return fetch(
          process.env.CYPRESS_TENDERLY_PROJECT + "/" + forkId + "/simulate",
          {
            ...
            body: JSON.stringify({
              ...
              gas_price: "0",
              generate_access_list: true,
              input: '0x095ea7b3000000000000000000000000be8563b89d31ad287c73da42848bd7646172e0ba0000000000000000000000000000000000000000000000009b32daf263dd9000',
              network_id: "1",
              save: true,
              to: "0xc18360217d8f7ab5e7c516566761ea12ce7f9d72",
              transaction_index: null,
      ...
      .then(res => fetch(
        process.env.CYPRESS_TENDERLY_PROJECT + "/" + forkId + "/simulate",
        {
          ...
          body: JSON.stringify({
            ...
            gas_price: "0",
            generate_access_list: true,
            input: '0x23b872dd000000000000000000000000be8563b89d31ad287c73da42848bd7646172e0ba00000000000000000000000032518828a071a0e6e549f989d4aab4cd7401be8f0000000000000000000000000000000000000000000000009b32daf263dd9000',
            network_id: "1",
            save: true,
            to: "0xc18360217d8f7ab5e7c516566761ea12ce7f9d72",
            transaction_index: null,
